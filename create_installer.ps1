# Create Simple Installer - Clean Version
# Eng. Hamza Damra
...
Write-Host ""
Write-Host "=====================================" -ForegroundColor Cyan
Write-Host "  Installation Package Created!     " -ForegroundColor Cyan
Write-Host "=====================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Package: .\$archiveName" -ForegroundColor Green
Write-Host "Folder:  .\$installerDir\" -ForegroundColor Green
Write-Host ""
